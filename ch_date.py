...
# Результат работы:
# C:\Work\python\dz3\Py3HW06>python ch_date.py 1 2 2023
# x = (1, 2, 2023) Дата корректна!
#
# C:\Work\python\dz3\Py3HW06>python ch_date.py 41 2 2023
# x = (41, 2, 2023) Ошибка в дате!
#
# C:\Work\python\dz3\Py3HW06>python ch_date.py 41 2
#         Ошибка в параметрах!
#         Запускайте команду в следующем виде:
#         ch_date <DD> <MM> <YYYY>
# Ошибка ввода!
#
# C:\Work\python\dz3\Py3HW06>python ch_date.py 29 02 1900
# x = (29, 2, 1900) Ошибка в дате!
#
# C:\Work\python\dz3\Py3HW06>python ch_date.py 29 02 1904
# x = (29, 2, 1904) Дата корректна!
#
# C:\Work\python\dz3\Py3HW06>python ch_date.py 29 02 qqq
# Ошибка ввода!
#
# C:\Work\python\dz3\Py3HW06>
